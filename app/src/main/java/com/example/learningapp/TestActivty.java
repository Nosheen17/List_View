...
public class TestActivty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        techList.add("Cat");
        techList.add("Dog");
        techList.add("Elephant");
        techList.add("Fish");
        techList.add("Goat");
        techList.add("Hen");

        // Put all the technology names with technology image resource ids in map.
        map.put(techList.get(0), R.drawable.app);
        map.put(techList.get(1), R.drawable.basketball);
        map.put(techList.get(2), R.drawable.cat);
        map.put(techList.get(3), R.drawable.dog);
        map.put(techList.get(4), R.drawable.elephant);
        map.put(techList.get(5), R.drawable.fish);
        map.put(techList.get(6), R.drawable.goat);
        map.put(techList.get(7), R.drawable.hen);
